...
public class Dispatcher {
    ...
    public static <T1 extends Store, T2 extends Store> Observable<Store> streamRemoteOrLocalFallbackStore(
            Context context,
            AbstractLogger log,
        ...
        // connection problem.
        Observable<Store> remoteStoreFallingBackToLocalOnConnectionFailure = remoteStore
        ...
        // disconnection
        Observable<Store> remoteOrLocalStoreDependingOnWifi = WifiStatus
            .stream(context, log)
