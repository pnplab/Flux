...
public class Accelerometer {
    ...
    static public abstract class AccelerometerEvent {

    }

    static public class AccelerometerTimepoint extends AccelerometerEvent {
    ...
    static public class AccelerometerAccuracyTimepoint extends AccelerometerEvent {
    ...
    public Flowable<AccelerometerEvent> run(Context context, AbstractLogger log) {
