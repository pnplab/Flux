...
public class WifiStatus {
    ...
    private static @NonNull Observable<Boolean> streamWifiStatusFromNetworkCapabilities(final Context context_, AbstractLogger log) {
        ...
        @NonNull Observable<Boolean> wifiStatusStream = Observable.create(emitter -> {
            ...
            NetworkRequest.Builder wifiCallbackRequestBuilder = new NetworkRequest
                    ...
                    // @note I suspect NET_CAPABILITY_NOT_RESTRICTED might
                    // detect network restriction due to doze restriction for
                    // instance (that otherwise might have to be detected,
        ...
        // emit 'false' (== no wifi).
        @NonNull Observable<Boolean> wifiStatusStreamWithFalseAfterTimeout = wifiStatusStream
                .timeout(
    ...
    public static @NonNull Observable<Boolean> stream(final Context context, AbstractLogger log) {
        ...
        if (_cachedStream == null) {
            ...
            // WritableStore new cached stream.
