...
public class Provider extends ContentProvider {
    ...
    // content://org.pnplab.flux.awareplugin.eegmuse.provider.eegmuse/eegmuse

    public static String AUTHORITY = "org.pnplab.flux.awareplugin.muse.provider.muse"; //change to package.provider.your_plugin_name
    ...
    public static final String DATABASE_NAME = "plugin_muse.db"; //the database filename, use plugin_xxx for plugins.

    //Add here your database table names, as many as you need
    public static final String DB_TBL_TEMPLATE = "muse";
    ...
    public static final class EEGMuse_Data implements AWAREColumns {
        ...
        public static final String CONTENT_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE + "/vnd.org.pnplab.flux.awareplugin.muse.provider.muse"; //modify me
        public static final String CONTENT_ITEM_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE + "/vnd.org.pnplab.flux.awareplugin.muse.provider.muse"; //modify me
    ...
    public static String getAuthority(Context context) {
        AUTHORITY = context.getPackageName() + ".provider.muse";
        Log.d("PNPLab/Provider", AUTHORITY);
        return AUTHORITY;
    }
