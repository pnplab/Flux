...
public class Accelerometer extends Aware_Sensor implements SensorEventListener {
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        rowData.put(Accelerometer_Data.TIMESTAMP, nowTimestamp);
        rowData.put(Accelerometer_Data.VALUES_0, mean[0]);
        rowData.put(Accelerometer_Data.VALUES_1, mean[1]);
        rowData.put(Accelerometer_Data.VALUES_2, mean[2]);
        rowData.put(Accelerometer_Data.ACCURACY, _worstAccuracy);
