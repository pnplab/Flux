 ...
 * @flow
 * 
 * cf. `https://gist.github.com/hyb175/beb9ceed4c34300ba7c77d3d6d44ae52`,
 * `https://github.com/realm/realm-js/issues/370#issuecomment-270849466`,
 * `https://gist.github.com/hyb175/beb9ceed4c34300ba7c77d3d6d44ae52#gistcomment-2322052`.
 * 
 * Also prevents `Error: .../Flux/default.realm: Encrypted interprocess sharing is currently unsupported.SharedGroup has been opened by pid: 68550. Current pid is 68895.`
 */

jest.mock('realm', () => {
    class Realm {
        __reset__() {
            const params = this.__params__;
        ...
        constructor(params) {
            this.__params__ = params; // just present for the sake of __reset__ method.
