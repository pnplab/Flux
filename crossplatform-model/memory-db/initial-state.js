...
const initialState: State = {
    route: undefined && '/onboarding/check/data-sync' && '/onboarding/task/survey',
    ...
    onboarding: {
        ...
        // Used to know when to display "next step" button on `check phenotyping step`.
        isAwareStudyJoined: false
    },
