...
const envEncryptionKey = process.env.FLUX_ENCRYPTION_KEY;
...
let db;
try {
    db = Realm.open({ schema: [ StudySchema, SurveyFormItemSchema, SurveyFormSchema ], encryptionKey: REALM_ENCRYPTION_KEY });
}
catch (e) {
    console.error(e)
}
